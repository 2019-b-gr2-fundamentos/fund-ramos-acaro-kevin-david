...
var tengoMosa = false;
var estaCasado = true; // expresion
var soyMosero = tengoMosa == true;
var casadoYMosero = estaCasado && soyMosero;
if (casadoYMosero) {
...
//FALSY
var calculo = "multiplicar"; // sumar restar multiplicar dividir
switch (calculo) {
    case "sumar":
        //Codigo
        break;
...
// 65 Longo
// 66 Ruku
var edadstring = prompt("Ingresas edad");
var edad = Number(edadstring);
if (edad >= 0 && edad <= 6) {
    console.log("Guagua");
}
else {
